    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="ui-card rounded-3xl max-w-lg w-full">
        ...
        <div className="flex justify-between items-center p-6 border-b border-slate-200 bg-white">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Record Fees Payment</h2>
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {!isNotApplicable && (
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition bg-white"
                >
                ...
                {isOtherPaymentMode ? (
                  <div>
                    ...
                    <textarea
                      ...
                      rows="4"
                      className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition resize-none"
                    />
                  </div>
                ) : (
                  <div>
            ...
            <div>
              ...
              {isNotApplicable && (
                <p className="text-xs text-slate-500 mt-2">Other fees marked as not applicable</p>
              )}
            </div>
          </form>
        </div>
